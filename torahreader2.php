...
foreach ($hebrewArray as $hebrewWord) {
	...
	foreach($hebrewLetter as $hebrewCharacter) {
		if (mb_ord($hebrewCharacter) == '1468') {
			//$hebrewLetter = "<span style='background-color:#FF00FF'>$hebrewLetter</span>";
			//echo $hebrewWord;
			//echo '<br>';
		}
		elseif (mb_ord($hebrewCharacter) != '1468') {
		//echo $hebrewWord;	
		//echo '<br>';
		//echo mb_ord($hebrewCharacter);
		}
	echo "<br>";	
		if(strpos(' ֑', $hebrewWord == true) {
